...
![dev news weekly responsive screenshot](documentation/final_views/)

## Introduction



View live site here : [Dev News Weekly (DNW)](https://dev-news-weekly-a3e77f0fbaae.herokuapp.com/)  
  
For Admin access with relevant sign-in information: [DNW Admin](https://freefido.herokuapp.com/admin/)

<hr>

## Table of Contents

- [Dev News Weekly](#dev-news-weekly)
...
Dev News Weekly is a .... Users are invited to:

- Join the community
- Create their own profiles
- Interact with articles
- Save and manage their favourite articles
- Upload useful resources
- Discover more web and software development
...
![](documentation/final_views/)  
*Original inspiration for the design process*


### Colour Scheme

As mentioned above, the colour scheme and logo drove the design of the website. I wanted to create a 'fun' environment for the user to create the connection with the enjoyment that they would have enagaging with the website's shared content. The colours represent different sections/features of the website. I balanced the vibrant shades with a classic, ```#fff``` white background and an off-black shade of ```#0d0d0d```, as I felt that it yielded a slightly more matte effect that ```#000``` black. This combination also yielded a high contrast ratio of 19.44 for accessibility, with my colour scheme also passing a Colour Blind Safe check via [Adobe Color](https://color.adobe.com/create/color-wheel). This check was important for accessibility as the colours would form the base for my page and feature icons. Each colour in the scheme was also contrast checked with black ```#0d0d0d``` to ensure no contrast issue, all passed.
...
Through Django's built-in Administration Panel, the Admin has full access over the data submitted to the website by registered Users. To access the Admin panel the Admin user adds '/admin/' to the end of the URL on display. A username and password is requested.
...
3. Create a new Django project in the terminal ```django-admin startproject dev_news_weekly .```
...
A new database instance was created on the [CI Database Maker](https://dbs.ci-dbs.net/) for my project. This tool is only available to Code Institute Students and Staff.
...
2. The [FreeFido Repository](https://github.com/amylour/PROJECTNAME) can be found at this location.
...
9. Using the ``pip3 install -r requirements.txt`` command, the dependencies and libraries needed for PROJECTNAME will be installed.
...
- [Unsplash](https://unsplash.com/)
 <details>
   ...
   - Newsprint Image Photo by Markus Spiske: https://www.pexels.com/photo/text-102152/
   - Photo by Tekosin Demir: https://www.pexels.com/photo/men-sitting-and-holding-newspapers-in-a-room-with-newspapers-on-the-walls-16877050/
